...
<li><p>The created 'node_modules' folder is pretty darn big, but is only there to assist development. There is no need to upload this folder when going live.</p></li>
